...
import {  SinglePie, MultiPie, RewardContract, OlptContract, pieAddress } from '@/tronlink/index';
...
export default {
    ...
    setup() {
      ...
      const onCheckToken = () => {
        Dialog.alert({
          title: '合约地址',
          message: pieAddress.single + ',' + pieAddress.multi,
        }).then(() => {
          // on close
        });
      }
      ...
      return {routerPaths,wellet_address,maxSupply , rewardUserIncome,code, onRouter,onCheckToken,  onGetWellet, onOpenWemmet, allIcomeAmount} 
    }
  };
</script>
<style lang="less">
